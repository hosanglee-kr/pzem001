...
//#define G_B51_PZEM_PZEM004V3 	static_cast<uint8_t>(pzmbus::pzmodel_t::pzem004v3)
//#define G_B51_PZEM_PZEM003 		static_cast<uint8_t>(pzmbus::pzmodel_t::pzem003)


#define 	G_B51_PZEM_MODEL_PZEM003	1
//#define 	G_B51_PZEM_MODEL_PZEM004V3 	0

//#define 	G_B51_PZEM_MODEL 				G_B51_PZEM_MODEL_PZEM003
//#define	G_B51_PZEM_MODEL				static_cast<uint8_t>(pzmodel_t::pzem003)	//pzem003	//pzmodel_t::pzem003		//	DC: PZ003, AC : PZ004
...
void B51_print_timeseries_each(uint8_t p_B51_TsC_ID){
	...
	// pzmodel_t v_pzmodel = g_B51_pz003->getState()->model;

	// if (v_pzmodel == pzmbus::pzmodel_t::pzem004v3) {
	// 	Serial.println("TimeStamp\t\tdV\tmA\tW\tWh\tdHz\tpf");

	// } else if (v_pzmodel == pzmbus::pzmodel_t::pzem003){
	// 	Serial.println("TimeStamp\t\tdV\tmA\tW\tWh");
