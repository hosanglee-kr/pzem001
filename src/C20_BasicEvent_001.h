...
void C20_init(){
    ...
    g_C20_b1.enableEvent(event_t::longPress);
    g_C20_b1.enableEvent(event_t::longRelease);
    g_C20_b1.enableEvent(event_t::autoRepeat);
    g_C20_b1.enableEvent(event_t::multiClick);

    // for button 'two' in addition to basic 'press' and 'release' we will enable only 'multiClicks'
    g_C20_b2.enableEvent(event_t::multiClick);
